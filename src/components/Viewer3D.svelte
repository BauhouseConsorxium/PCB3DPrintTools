<script>
  ...
  let { bodies = [], visibility = {}, zScale = 8, textZScale = 8, textMode = 'raise', boardZScale = 1, previewFilter = null, traceMode = 'raise', drcViolations = [], isRebuild = false, encSideBySide = false, rawSegments = null, silkPolylines = null, copperTextPolylines = null, boardThickness = 0, showDimensions = false } = $props()
  ...
  function buildDimensions() {
    ...
    const lineMat = new THREE.LineBasicMaterial({ color: dimColor, depthTest: false })
